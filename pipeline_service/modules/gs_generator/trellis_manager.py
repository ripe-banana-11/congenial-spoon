    ...
    def generate(
        ...
        try:
            ...
            if num_images == 1:
                ...
                # Multi-image mode - use run_multi_image_with_voxel_count() with adaptive texture steps
                logger.info(f"Using multi-image pipeline (run_multi_image_with_voxel_count) with mode={params.mode}")
